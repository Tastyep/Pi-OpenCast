...
class WorkflowFactory(object):
    ...
    def make_video_workflow(*args, **kwargs):
        return VideoWorkflow(*args, **kwargs)

    def make_queue_video_workflow(*args, **kwargs):
        return QueueVideoWorkflow(*args, **kwargs)

    def make_queue_playlist_video_workflow(*args, **kwargs):
        return QueuePlaylistWorkflow(*args, **kwargs)

    def make_stream_video_workflow(*args, **kwargs):
        return StreamVideoWorkflow(*args, **kwargs)

    def make_stream_playlist_video_workflow(*args, **kwargs):
